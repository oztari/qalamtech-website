  ...
  return (
    ...
    >
      ...
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
         Monthly updates on tech advancements, automation, and strategies to expand your audience.
      </p>
      <div>
        <input
          type="text"
    ...
    <div className="wow fadeInUp shadow-three dark:bg-gray-dark relative z-10 rounded-sm bg-white p-8 sm:p-11 lg:p-8 xl:p-11" data-wow-delay=".2s">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input
          ...
          className="shadow-submit dark:shadow-submit-dark mb-5 flex w-full cursor-pointer items-center justify-center rounded-sm bg-primary px-9 py-4 text-base font-medium text-white duration-300 hover:bg-primary/90"
        />
        {status && <p className="dark:text-body-color-dark text-center text-base leading-relaxed text-body-color">{status}</p>}
        <p className="dark:text-body-color-dark text-center text-base leading-relaxed text-body-color">No spam. Ever.</p>
      </form>

      {/* SVG decorations */}
      <div>
        <span className="absolute left-2 top-7">{/* SVG1 */}</span>
        <span className="absolute bottom-24 left-1.5">{/* SVG2 */}</span>
        <span className="absolute right-2 top-[140px]">{/* SVG3 */}</span>
        <span className="absolute right-0 top-0">{/* SVG4 */}</span>
      </div>
    </div>
  );
};
