...
const Footer = () => {
  ...
  // Retry scroll until element exists
      ...
      <div className="container">
        <div className="-mx-4 flex flex-wrap">
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
            <div className="mb-12 max-w-[360px] lg:mb-16">
              <Link href="/" className="mb-8 inline-block">
                <Image src="/images/logo/logo-2.png" alt="logo" className="w-full dark:hidden" width={140} height={30} />
                <Image src="/images/logo/logo.png" alt="logo" className="hidden w-full dark:block" width={140} height={30} />
              </Link>
              <p className="dark:text-body-color-dark mb-9 text-base leading-relaxed text-body-color">
                Crafting high-quality software and web solutions to empower your business.
              </p>
            </div>
          </div>
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
            ...
            <ul>
              ...
              <li>
                <Link href="/about" className="dark:text-body-color-dark mb-4 inline-block text-base text-body-color duration-300 hover:text-primary dark:hover:text-primary">
                  About
                </Link>
              </li>
            </ul>
        ...
        <div className="py-8 text-center text-base text-body-color dark:text-white">
          <span>&copy; {new Date().getFullYear()} QalamTech. All rights reserved.</span>
        </div>
      </div>
    </footer>
  );
